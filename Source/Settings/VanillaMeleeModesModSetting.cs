...
namespace VMM_VanillaMeleeModes.Settings
{
    public class VanillaMeleeModesModSetting : ModSettings
    {
        ...
        public float aggressive_ArmorPenetration = 1f;
        ...
        public float flurry_ArmorPenetration = 1f; 
        ...
        public float guard_ArmorPenetration = 1f;
        ...
        public override void ExposeData()
        {
            ...
            Scribe_Values.Look(ref aggressive_ArmorPenetration, "aggressive_ArmorPenetration", 1f);
            ...
            Scribe_Values.Look(ref flurry_ArmorPenetration, "flurry_ArmorPenetration", 1f);
            ...
            Scribe_Values.Look(ref guard_ArmorPenetration, "guard_ArmorPenetration", 1f);
        ...
        public void ResetSetting()
        {
            ...
            aggressive_ArmorPenetration = 1f;
