...
namespace VMM_VanillaMeleeModes.ModSettingUI
{
    internal static class VMM_UI_SettingGroup
    {
            ...
            )
        {
            ...
            // 近战格挡减伤
            DrawSliderWithInput_Float(innerLs, "VMM_MeleeParryDamageReduction_Label".Translate(), ref meleeParryDamageReduction);
            // 近战格挡反击
            DrawSliderWithInput_Float(innerLs, "VMM_MeleeCounterChance_Label".Translate(), ref meleeCounterChance);
